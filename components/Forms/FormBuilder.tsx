  ...
  return (
    <div className="flex flex-col h-[calc(100vh-8rem)] bg-slate-50 rounded-2xl border border-slate-200 shadow-xl overflow-hidden animate-[fadeIn_0.3s_ease-out]">
      ...
      <PageHeader
        ...
        subtitle="Editor dinâmico de formulários e testes clínicos"
        showBackButton
        onBackClick={onCancel}
        containerClassName="mb-0 bg-white/80 backdrop-blur-md rounded-none border-b border-slate-200"
        actions={
          <div className="flex items-center gap-3">
             <div className="hidden lg:flex bg-slate-100/80 p-1 rounded-xl gap-1 mr-4">
                {[
