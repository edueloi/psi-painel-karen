...
export const AppCard: React.FC<AppCardProps> = ({
  ...
  return (
    <div
      onClick={onClick}
      className={cx(
        'relative overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm transition-all',
    ...
    >
      {selectable && (
        <button
          ...
          className={cx(
            'absolute left-3 top-3 z-10 flex h-6 w-6 items-center justify-center rounded-lg border transition',
            selected
      ...
      <div className="flex items-start justify-between gap-3">
        <div className={cx('flex min-w-0 items-start gap-3', selectable && 'pl-6')}>
          <div className="shrink-0">
            {imageUrl ? (
              ...
              >
                {avatarIcon || avatarText || title.charAt(0)}
              </div>
            )}
          </div>
