...
import { COUNTRIES, CountrySelect, maskPhone } from '../UI/CountrySelect';

/* ─── CPF/CNPJ e CEP (COUNTRIES/maskPhone/CountrySelect movidos para
   components/UI/CountrySelect.tsx, reaproveitados também no cadastro
   público do paciente) ────────────────────────────────────────────── */
const mkP = (v: string) => maskPhone(v, 'BR');
const mkC = (v: string) => {
  v = v.replace(/\D/g, "");
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <div className="flex gap-1.5">
                <CountrySelect
                  ...
                  onChange={v => updateField('phone_country', v)}
                />
                <input
                  type="tel"
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <div className="flex gap-1.5">
                <CountrySelect
                  ...
                  onChange={v => updateField('phone2_country', v)}
                />
                <input
                  type="tel"
