  ...
  try {
    ...
    const [result] = await db.query(
      ...
      [
        ...
        spouse_name || null, spouse_phone || null, family_contact || null,
        emergency_contact || null, emergency_contacts || null,
  ...
  try {
    ...
    await db.query(
      ...
      [
        ...
        phone ?? null, (whatsapp ?? phone) || null,
        phone2 !== undefined ? (phone2 || null) : existing[0].phone2,
        sanitizedBirthDate !== undefined ? (sanitizedBirthDate || null) : existing[0].birth_date,
        cpf ?? null,
        rg !== undefined ? (rg || null) : existing[0].rg,
        gender !== undefined ? (gender || null) : existing[0].gender,
        marital_status !== undefined ? (marital_status || null) : existing[0].marital_status,
        education !== undefined ? (education || null) : existing[0].education,
        profession !== undefined ? (profession || null) : existing[0].profession,
        nationality !== undefined ? (nationality || null) : existing[0].nationality,
        naturality !== undefined ? (naturality || null) : existing[0].naturality,
        has_children !== undefined ? (has_children ? 1 : 0) : null,
        children_count ?? null, minor_children_count ?? null,
        spouse_name !== undefined ? (spouse_name || null) : existing[0].spouse_name,
        spouse_phone !== undefined ? (spouse_phone || null) : existing[0].spouse_phone,
        family_contact !== undefined ? (family_contact || null) : existing[0].family_contact,
        emergency_contact !== undefined ? (emergency_contact || null) : existing[0].emergency_contact,
        emergency_contacts ?? null,
        address !== undefined ? (address || null) : existing[0].address,
        city !== undefined ? (city || null) : existing[0].city,
        state !== undefined ? (state || null) : existing[0].state,
        zip_code !== undefined ? (zip_code || null) : existing[0].zip_code,
        notes !== undefined ? (notes || null) : existing[0].notes,
        status ? normalizeStatus(status) : null,
        responsible_professional_id !== undefined ? (responsible_professional_id || null) : existing[0].responsible_professional_id,
        responsible_name !== undefined ? (responsible_name || null) : existing[0].responsible_name,
        responsible_phone !== undefined ? (responsible_phone || null) : existing[0].responsible_phone,
        health_plan !== undefined ? (health_plan || null) : existing[0].health_plan,
        diagnosis !== undefined ? (diagnosis || null) : existing[0].diagnosis,
