...
export const Planos: React.FC = () => {
  ...
  useSEO({
    ...
    description: 'Conheça os planos do Plaelo para psicólogos, psiquiatras e clínicas de saúde mental. Sem fidelidade, com IA inclusa e 14 dias de teste grátis.',
    path: '/planos',
  });
